...
var paulArr = ["Schwartzer", "Furore GT", "Kuruma (armored)", "Coquette Topless", "RH8", "9F Cabrio", "Sentinel", "Surge", "Daemon", "Bagger", "Sanchez", "Nemesis", "Akuma", "Redwood Gauntlet", "Stratum", "BF400", "Futo", "Brioso R/A", "Granger", "Jackal", "Seven-70", "Double-T", "Buffalo S", "Virgo", "Khamelion", "FMJ", "F620", "Gang Burrito", "Buccaneer Custom Topless", "Phoenix", "Issi", "Burger Shot Stallion", "Dubsta 6x6", "Coquette Classic Topless", "Nightshade", "Pisswasser Dominator", "Omnis", "X80 Proto", "Sultan RS", "Voltic", "Reaper", "Infernus", "Vacca"];
